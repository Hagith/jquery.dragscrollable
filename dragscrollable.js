...
(function($) { // secure $ jQuery alias
   ...
   * ------------------------------------------------------------------------
   *  threshold             | Defines threshold for "dragscroll" event (in pixels).
   * ------------------------------------------------------------------------
   *  axis                  | Defines which axis should be scrollable 'x', 'y' or 'both'.
   *                        | Defaults to 'both'.
   * ------------------------------------------------------------------------
   *
   *  usage examples:
    ...
    var dragscroll = {
      ...
      mouseMoveHandler: function(event) { // User is dragging
        ...
        if (delta.left || delta.top) {
          ...
          event.data.scrollable.scrollLeft(xPos);
          event.data.scrollable.scrollTop(yPos);
